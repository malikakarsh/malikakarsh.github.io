...
const data = [{
    Title: 'About Me',
    About: "I'm an Instrumentation and Control undergraduate pursuing my B.tech in National Institute of Technology, Tiruchirappalli.",
    Description: "I'm currently a core member at Delta Force (premiere coding club of NITT), I love reading about different web vulnerabilities and discovering bugs in web applications.",
